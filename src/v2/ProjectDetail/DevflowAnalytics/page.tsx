...
import {
  ...
  TEAM,
  USE_CASE,
} from "./devflow-analytics.model";

export const DevflowAnalyticsPage = () => {
  return (
    <div>
      ...
      <main className="mx-auto flex w-full flex-col gap-20 px-[6%] py-16 md:px-[22%]">
        <Reveal>
          ...
          <p className="mt-2 text-xs text-zinc-400">{HERO_IMAGE.caption}</p>
        </Reveal>
        ...
        <Reveal>
          <h2 className="mb-2 text-2xl font-bold text-zinc-950">Casos de uso primeiro</h2>
          <p className="mb-6 text-sm leading-relaxed text-zinc-600">{USE_CASE.description}</p>
          <div className="overflow-hidden rounded-lg border border-zinc-200 bg-white p-6">
            <img
              src={USE_CASE.image}
              alt={USE_CASE.imageAlt}
              loading="lazy"
              className="mx-auto w-full max-w-2xl object-contain"
            />
          </div>
        ...
        <Reveal className="overflow-hidden rounded-lg bg-black">
          <GridBackground cellWidth={32} cellHeight={32}>
