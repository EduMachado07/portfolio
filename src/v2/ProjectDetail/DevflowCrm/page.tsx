...
import {
  ...
  STACK_GROUPS,
  TEAM,
} from "./devflow-crm.model";

export const DevflowCrmPage = () => {
  return (
    <div>
      <GridBackground cellWidth={52} cellHeight={52}>
        <header className="relative overflow-hidden px-[6%] py-16 md:px-[18%] md:py-20">
          ...
          <img
            ...
            alt=""
            aria-hidden="true"
            className="pointer-events-none absolute -bottom-6 right-[18%] hidden w-44 rotate-6 object-contain opacity-[0.4] sm:block"
          />
      ...
      <main className="mx-auto flex w-full flex-col gap-20 px-[6%] py-16 md:px-[22%]">
        <Reveal>
          <div className="overflow-hidden rounded-lg border border-zinc-200 shadow-sm">
            <img
              src={HERO_IMAGE}
              alt="Telas do DevFlow CRM: dashboard com KPIs e gráficos, gestão de leads e log de auditoria"
              loading="lazy"
        ...
        <Reveal>
          <h2 className="mb-2 text-2xl font-bold text-zinc-950">Autenticação e papéis</h2>
          <p className="mb-6 text-sm text-zinc-500">
            Como o login e as permissões funcionam, na prática:
          </p>
