...
export const HERO_PARAGRAPHS = [
  "Sou desenvolvedor Full Stack em formação pela Fatec Jacareí, em Desenvolvimento de Software Multiplataforma, com o técnico em Desenvolvimento de Sistemas já concluído pela Etec São José dos Campos. Gosto de entregar sistemas de ponta a ponta: Front-end, Back-end, Banco de Dados, segurança e a documentação de tudo isso — sem deixar nenhuma parte pra trás.",
