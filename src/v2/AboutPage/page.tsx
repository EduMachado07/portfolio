  ...
  return (
    <div className="bg-zinc-100/50">
      <GridBackground cellWidth={48} cellHeight={48}>
        <section className="relative flex flex-col-reverse items-center gap-12 overflow-hidden px-[6%] py-20 md:flex-row md:px-[20%] md:py-28">
          <Reveal className="flex flex-1 flex-col items-center gap-5 text-center md:items-start md:text-left">
            ...
            {HERO_PARAGRAPHS.map((paragraph) => (
              <p
                key={paragraph}
                className="max-w-2xl text-base leading-relaxed text-zinc-800 sm:text-lg"
              >
                {paragraph}
              </p>
            ))}
