    ...
    return (
        <main className="flex-1 flex flex-col items-start gap-14 pb-12">
            ...
            <section className="px-[12vw] flex flex-col gap-8 -mt-12">
                ...
                <div className="flex w-5/6 justify-between">
                    ...
                    <p className="text-zinc-200 font-supreme text-lg flex flex-col gap-2">
                        <span className="font-supreme-bold text-xl text-[#3399FF]">
                            Tipo de projeto:
                        </span>
                ...
                <p className="text-zinc-200 font-supreme text-lg flex flex-col gap-3 w-4/6">
                    <span className="font-chubbo-bold text-2xl text-orange-400/90">
                        Motivo
                    </span>
                    <span>
                    ...
                    <div className="flex gap-12">
                        <span className="font-supreme-bold -mr-4 text-orange-400/90">
                            Fale comigo:
                        </span>
                        <Link
                            to="/contact"
                ...
                {/* IMG PROJECT */}
                <p className="font-supreme-bold text-xl text-[#3399FF] -mb-4">
                    Imagens do Projeto
                </p>
                <img
                    src={wall}
                ...
                />
                {/* PRODUCT BACKLOG */}
                <p className="font-chubbo-bold text-3xl text-[#3399FF]">
                    Requisitos
                </p>
                <div className="w-9/10 flex flex-col gap-8">
                    <h2 className="-mb-6 font-supreme-bold text-xl">
            ...
            <section className="bg-[#222] py-12 px-[12vw] shadow-md dark:shadow-zinc-800 flex flex-col gap-4">
                ...
                <h1 className="font-chubbo-bold text-3xl text-[#3399FF]">Progresso</h1>
                <Carousel orientation="horizontal" className="w-5/6 px-20">
            ...
            <section className="w-full h-[70vh] px-[12vw] flex flex-col gap-8">
                <h1 className="font-chubbo-bold text-3xl text-[#3399FF]">Resumo do Projeto</h1>
                <iframe
