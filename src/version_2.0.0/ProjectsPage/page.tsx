      ...
      <GridBackground cellWidth={48} cellHeight={48}>
        <section className="relative flex flex-col items-center gap-5 overflow-hidden px-[6%] py-16 text-center sm:gap-6 sm:py-20 md:px-[28%] md:py-28">
          <img
            ...
            alt=""
            aria-hidden="true"
            className="pointer-events-none absolute -top-2 left-6 w-22 rotate-[160deg] object-contain opacity-[0.18] sm:top-[-1rem] sm:left-32 sm:w-36 sm:opacity-[0.25]"
          />
          <img
            src={bateriaImg}
            alt=""
            aria-hidden="true"
            className="pointer-events-none absolute -bottom-4 -left-4 w-36 rotate-[-6deg] object-contain opacity-[0.18] sm:-bottom-10 sm:-left-10 sm:w-64 sm:opacity-[0.25]"
          />
          <img
            src={pratoImg}
            alt=""
            aria-hidden="true"
            className="pointer-events-none absolute -top-2 -right-2 w-24 rotate-6 object-contain opacity-[0.15] sm:-top-6 sm:-right-4 sm:w-36 sm:opacity-[0.25]"
          />
          <img
            src={tamborImg}
            alt=""
            aria-hidden="true"
            className="pointer-events-none absolute -bottom-2 -right-3 w-22 rotate-[8deg] object-contain opacity-[0.18] sm:-bottom-4 sm:-right-10 sm:w-28 sm:opacity-[0.25]"
          />
          ...
          <span className="relative flex max-w-2xl flex-col gap-1 text-center">
            <p className="relative text-sm leading-relaxed text-zinc-600 sm:text-base md:text-lg">
              Aqui estão os sistemas que carreguei do papel até a produção —
              cada um com o problema que resolvi, as decisões técnicas por trás
              e o resultado final. Se você programa, vai curtir ver o processo.
              <br />
            </p>
            <p className="relative text-sm leading-relaxed text-zinc-600 sm:text-base md:text-lg rounded-sm font-medium bg-blue-300/50 p-1.5">
                  ...
                  <div className="overflow-hidden rounded-md border border-zinc-200">
                    {project.img ? (
                      ...
                      <GridBackground
                        cellWidth={42}
                        cellHeight={42}
                        style="transition-transform duration-200 group-hover:scale-105"
                      >
