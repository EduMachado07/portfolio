...
export const ProjectsSection = () => {
  return (
    <section className="bg-zinc-200/50 flex flex-col gap-4 py-12 sm:py-16 lg:gap-8 lg:py-16">
        ...
        {FeaturedProjects.map((project, index) => {
          ...
          return (
            <article key={project.slug} className="border-zinc-200">
              <div
                className={`mx-auto flex w-full max-w-6xl flex-col items-center gap-8 px-[6%] py-12 sm:gap-10 sm:py-16 md:py-20 lg:gap-16 lg:px-12 lg:py-24 ${
